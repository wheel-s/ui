  ...
  return (
    <div>
      ...
      <div className='mt-3  p-10 max-sm:p-6'>
        <Link href='/'><p className='text-[hsl(166,60%,69%)] ml-[1] mt-4 ml-4 mb-1 font-mono font-medium text-[1.1rem]'>← Georege Ezra </p></Link> 
        <h1 className='mb-7 text-4xl  font-black ml-[-3]  font-mono text-slate-300'>All Projects</h1>
        ...
        <section>
          ...
          <table>
            <thead >
              ...
              <th ><p className='text-slate-300 font-mono mt-6'>year</p></th>
              <th><p className='ml-7 font-mono  mt-6 text-slate-300'>project</p></th>
