  ...
  return (
    <div className="lg:fixed xl:p-10 " >
        <div className=" p-7 mt-5 lg:mt-0">
            <h1 className="text-[2.45rem] -ml-1 text-slate-300 font-extrabold lg:text-6xl">George Ezra</h1>
            <h3 className="text-[1.19rem]  font-semibold text-[#d4daed]  mt-3 p-">Software Engineer</h3>
            <p className="mt-3 md:w-[24rem] text-[1.07rem]   font-medium tracking-[-.03rem] text-[hsl(225,16%,61%)] ">I build accessible, digital experiences for the web.</p>
        </div>
