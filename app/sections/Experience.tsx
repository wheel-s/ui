...
const Experience = () => {
  ...
  return (
    <div >
      <div className="p-7 font-mono mt-16 lg:mt-23">
        <h1 className="mb-10 text-lg text-white tracking-widest font-bold lg:hidden" >EXPERIENCE</h1>
        ...
        <section className="sm:flex ">
            ...
            <div className="">
                ...
                <p className=" text-[hsl(225,18%,61%)] font-medium font-mono tracking-[-0.03rem] text-sm  mt-4">
                ...
                <div className="grid  grid-cols-3 md:grid-cols-4 gap-3  w-70 md:w-100 font-sans text-[.77rem] mt-4 ">
                    <div className=""><Button text='Python'/></div>
                    <div className="-ml-2.5"><Button text='TypeScript'/></div>
                    <div className=""><Button text='React'/></div>
                    <div className="md:-ml-6"><Button text='TailwindCSS'/></div>
        ...
        <section className="sm:flex mt-15  lg:mt-20">
          ...
          <div className="mb-4 w-full text-[#8892b0] ">2022 — 2023 </div>
            <div className="xl:-ml-12 ">
                ...
                <p  ref={ref}  className=" text-[hsl(225,18%,61%)] font-mono font-medium tracking-[-0.03] text-sm  mt-4">
                ...
                <div className="grid grid-cols-3 md:grid-cols-4 gap-2.5 w-70 md:w-100 font-sans text-[.78rem] mt-4">
                    <Button text=""/> 
                    <div  ref={ref}  className="ml-2"><Button text="React"/></div> 
                    <div className="-ml-5 text-[.rem]"><Button text="SCSS"/></div>
                  <div className="md:-ml-14"><Button text="Python"/></div> 
        ...
        <div className="flex mt-6  hover:text-[hsl(166,100%,49%)]">
           <Link href='/resume.png' className="flex">
            <h1 className="mt-9 text-slate-300  font-semibold text-md  hover:text-[#00fac0] font-mono" >View Full Resume </h1>
            <p className=" mt-8 ml-2 rotate-[-15deg] text-white text-md hover:text-[#00fac0]  max-sm:rotate-[-29deg] max-sm:ml-1.5">→</p>
           </Link> 
        </div>
