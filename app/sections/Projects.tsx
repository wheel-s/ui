...
import a3  from '../../public/images/hpp.png'
      ...
      <div className='p-7 man  text-[hsl(225,18%,61%)'>
        ...
        <section className='sm:flex justify-opossite  mt-12'>
            ...
            <div className=' sm:w-[150%] '>
                <a target='_blank' href={"https://github.com/wheel-s/car-ui"}><h1 className='mt-5 mb-3   cursor-pointer text-white'>Car Arena</h1></a>
                <p  className=' man tracking-normal text-[.92rem] text-[hsl(225,18%,61%)] '>
        ...
        <section className='sm:flex justify-opossite mt-13'>
            ...
            <div  ref={ref}className=' sm:w-[150%] '>
          <a  target='_blank' href="https://github.com/wheel-s/http-from-tcp"><h1 className='mt-5 mb-3  text-white text-md cursor-pointer '>Http From Tcp</h1></a>     
                <p ref={ref}  className=' tracking-normal text-[.92rem] text-[hsl(225,18%,61%)] '>
              ...
              <div className='-order-1 w-full mt-6 max-sm:'>
                <Image src={a3} alt='car' width={200} className='rounded-md h-28  ring-1 ring-gray-500  hover:ring-slate-400'/>
            </div>
        ...
        <section className='sm:flex justify-opossite mt-13'>
            ...
            <div className=' sm:w-[150%] '>
                <a  target='_blank' href="https://github.com/wheel-s/redis-server"><h1 className='mt-5 mb-5 text-md text-white crsor-pointer'>Redis Server</h1></a>
                <p   className=' man tracking-normal text-[.92rem] text-[hsl(225,18%,61%)] '>
       ...
       <Link  href='archive' className='flex hover:text-[#00fac0] '>
        <h1 className='mt-20 text-slate-300  mb-7 font-bold hover:text-[#00fac0] '>View Full Project Archive </h1>
